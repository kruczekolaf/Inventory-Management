function add_to_summary() {
  ...
  const inventory_spreadsheet = SpreadsheetApp.openById("YOUR_INVENTORY_WORK_AREA_2_ID");
  const summary_sheet = inventory_spreadsheet.getSheetByName("Work Area 2 Summary");
  ...
  const source_sheet = inventory_spreadsheet.getSheetByName("Work Area 2");
